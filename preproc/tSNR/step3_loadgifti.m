...
snr_dir = '/fslgroup/grp_proc/compute/Utah_analysis/parc_output_fs6_UT_ALL/quant_metrics/tSNR';
parc_dir = '/fslgroup/grp_proc/compute/Utah_analysis/parc_output_fs6_UT_ALL/generate_individual_parcellations/ind_parcellation/test_set';
out_dir= '/fslgroup/fslg_spec_networks/compute/code/Utah_analysis/tSNR/ALL';

%Load text file
    filename = '/nobackup/scratch/grp/fslg_spec_networks/code/Utah_analysis/tSNR/ALL/ids.txt';
    delimiter = {''};
...
filename = fullfile(out_dir, 'Utah_Network_AVG_SNR_230614.csv');
