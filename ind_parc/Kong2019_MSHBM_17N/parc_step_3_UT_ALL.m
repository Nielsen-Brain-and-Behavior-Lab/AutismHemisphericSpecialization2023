...
%% Subs with 1 run
%Load text file
    filename = '/nobackup/scratch/grp/fslg_spec_networks/code/Utah_analysis/Kong2019_parc_fs6_ALL/sess_numbers/1_sess.txt';
    delimiter = {''};
...
project_dir = '/fslgroup/grp_proc/compute/Utah_analysis/parc_output_fs6_UT_ALL/generate_individual_parcellations';
...
%% Subs with 2 runs
%Load text file
    filename = '/nobackup/scratch/grp/fslg_spec_networks/code/Utah_analysis/Kong2019_parc_fs6_ALL/sess_numbers/2_sess.txt';
    delimiter = {''};
    % Format for each line of text:
    %   column1: text (%s)
    % For more information, see the TEXTSCAN documentation.
